...
/**
 * This function converts literals to strings.
 * Numbers are represented with 10 decimal points to improve precision
 * in sound processing using WGSL.
 */
export function toStringWGSL(x: any): string {
  if (typeof x == 'number') {
    return x.toFixed(10)
  }
  return x.toString()
