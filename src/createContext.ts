...
const createContext = <T>(
  ...
  const context = {
    ...createEmptyContext(
      // fullJS includes all Source 4 builtins and preludes
      chapter === Chapter.FULL_JS ? Chapter.SOURCE_4 : chapter,
      variant,
      externalSymbols,
      externalContext
    ),
    chapter: chapter === Chapter.FULL_JS ? Chapter.FULL_JS : chapter
  }
