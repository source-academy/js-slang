...
import { expectParsedError, expectParsedErrorsToEqual, expectResult } from "../../utils/testing/testers";
...
expectParsedErrorsToEqual([
  ...
  [
    'Cannot have incomplete statements',
    '5',
  ...
  [
    'No new',
    'const b = new box();',
    'Line 1: New expressions are not allowed.'
  ],
  [
...
test('No array expressions in chapter 2', async () => {
  await expectParsedError('[];', Chapter.SOURCE_2).toEqual('Line 1: Array expressions are not allowed.')
