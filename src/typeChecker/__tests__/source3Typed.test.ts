...
describe('source 3 typed tests', () => {
  ...
  describe('array type', () => {
    ...
    it('handles nested array types', ({ context }) => {
      const code = `const arr1: number[][] = [[1], [2], [3]]; // no error
        const arr2: string[][] = [['1'], ['2'], ['3']]; // no error
        const arr3: number[][] = [[1], ['2'], [3]]; // no error
        const arr4: boolean[][] = [[1], ['2'], [3]]; // error
  ...
  describe('array access', () => {
    it('index must be success type of number', ({ context }) => {
    ...
    it('variable being accessed must be array', ({ context }) => {
      const code = `const arr: number[] = [1, 2, 3];
  ...
  describe('variable assignment', () => {
    ...
    it('cannot assign to const', ({ context }) => {
  ...
  describe('while loops', () => {
    it('predicate must be success type of boolean', ({ context }) => {
  ...
  describe('binary operations', () => {
    it('=== and !== allows any type on both sides', ({ context }) => {
