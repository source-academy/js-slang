...
describe('source 2 typed tests', () => {
  ...
  describe('pair', () => {
    ...
    it('pair() must take in 2 arguments', ({ context }) => {
    ...
    it('lists (except null) are pairs', ({ context }) => {
    ...
    it('type alias with the same name cannot be declared', ({ context }) => {
  ...
  describe('list', () => {
    ...
    it('pair with list as tail type is considered a list', ({ context }) => {
  ...
  describe('head', () => {
    it('takes in 1 pair or list as argument only', ({ context }) => {
    ...
    it('return type for pair is type of first element in pair', ({ context }) => {
    ...
    it('return type for list is element type in list', ({ context }) => {
  ...
  describe('tail', () => {
    ...
    it('return type for pair is type of second element in pair', ({ context }) => {
      const code = `const x1: Pair<number, number> = pair(1, 2);
    ...
    it('return type for list is tail type of list', ({ context }) => {
      const code = `const x1: List<number> = list(1, 2);
      const x2: List<string> = list('1', '2');
      const x3: List<string | number> = list('1', 2);
  ...
  describe('list library functions (select)', () => {
    it('handles types correctly', ({ context }) => {
