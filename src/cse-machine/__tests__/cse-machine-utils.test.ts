...
describe(hasBreakStatement, () => {
  ...
  const ifCases: TestCase[] = [
    ['If statement without alternative', 'if (true) { break; }', true],
    ['If statement with alternative', 'if (true) { break; } else { break; }', true],
...
describe(hasContinueStatement, () => {
  // If statements
  const ifCases: TestCase[] = [
    ['If statement without alternative', 'if (true) { continue; }', true],
    ['If statement with alternative', 'if (true) { continue; } else { continue; }', true],
...
describe(hasReturnStatement, () => {
  const ifCases: TestCase[] = [
    ['If with only consequent and no returns', 'if (true) {}', false],
    ['If with only consequent and single return', 'if (true) { return }', true],
