/**
 * Source Mode Chapter 2 for Ace Editor
...
//source highlight rules for source 2
function _SourceHighlightRules(acequire, exports, module) {
    ...
    var SourceHighlightRules = function(options) {
        let keywordMapper = this.createKeywordMapper({
            ...
            "support.function":
                "alert|"                                                                   + //built-in
                chapter1.functions + "|" + chapter2.functions                              , //chapter 1
...
ace.define("ace/mode/source2",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/source_highlight_rules","ace/mode/matching_brace_outdent","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], _Mode);
