/**
 * Source Mode Chapter 3 for Ace Editor
...
//source highlight rules for source 3
...
function _Mode(acequire, exports, module) {
    ...
    var SourceHighlightRules = acequire("./source_highlight_rules3").SourceHighlightRules;
    ...
    (function() {
        ...
        this.$id = "ace/mode/source3";
    }).call(Mode.prototype);

    exports.Mode = Mode;
}

ace.define("ace/mode/source_highlight_rules3",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], _SourceHighlightRules);
ace.define("ace/mode/source3",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/source_highlight_rules3","ace/mode/matching_brace_outdent","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], _Mode);
