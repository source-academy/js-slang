...
//source highlight rules for source 1
function _SourceHighlightRules(acequire, exports, module) {
    ...
    var SourceHighlightRules = function(options) {
        ...
        var escapedRegex = "\\\\(?:x[0-9a-fA-F]{2}|" + // hex
...
function _MatchingBraceOutdent(acequire, exports, module) {
    "use strict";
...
function _FoldingCstyle(acequire, exports, module) {
    "use strict";
...
function _Mode(acequire, exports, module) {
    ...
    var SourceHighlightRules = acequire("./source_highlight_rules1").SourceHighlightRules;
...
ace.define("ace/mode/source_highlight_rules1",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], _SourceHighlightRules);
ace.define("ace/mode/source1",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/source_highlight_rules1","ace/mode/matching_brace_outdent","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], _Mode);
ace.define("ace/mode/matching_brace_outdent",["require","exports","module","ace/range"], _MatchingBraceOutdent);
ace.define("ace/mode/folding/cstyle",["require","exports","module","ace/lib/oop","ace/range","ace/mode/folding/fold_mode"], _FoldingCstyle);
