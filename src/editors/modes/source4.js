/**
 * Source Mode Chapter 4 for Ace Editor
 ...
 * 3) delete document_highlight_rule, cstyle and matching_brace_outdent
 */

//source highlight rules for source 4
    ...
    var SourceHighlightRules = function(options) {
        let keywordMapper = this.createKeywordMapper({
            ...
            "support.function":
                ...
                chapter2.functions + "|"                                                   + //chapter 2
                chapter3.functions + "|"                                                   + //chapter 3
                chapter4.functions                                                         , //chapter 4 
...
function _Mode(acequire, exports, module) {
    ...
    var SourceHighlightRules = acequire("./source_highlight_rules4").SourceHighlightRules;
    ...
    (function() {
        ...
        this.$id = "ace/mode/source4";
    }).call(Mode.prototype);

    exports.Mode = Mode;
}

ace.define("ace/mode/source_highlight_rules4",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], _SourceHighlightRules);
ace.define("ace/mode/source4",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/source_highlight_rules4","ace/mode/matching_brace_outdent","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], _Mode);
