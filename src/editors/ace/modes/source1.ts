...
// @ts-ignore
function _SourceHighlightRules1(acequire, exports, module) {
  'use strict'
    ...
    let keywordMapper = this.createKeywordMapper(
      {
        ...
        'support.function': 'alert|' + chapter1.functions, //built-in //chapter 1
...
//source mode
// @ts-ignore
function _Mode1(acequire, exports, module) {
  'use strict'
