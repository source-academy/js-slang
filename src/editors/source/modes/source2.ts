...
// @ts-ignore
function _SourceHighlightRules2(acequire, exports, module) {
  'use strict'
...
//source mode
// @ts-ignore
function _Mode2(acequire, exports, module) {
  'use strict'

  var oop = acequire('../lib/oop')
  var TextMode = acequire('./text').Mode
  var SourceHighlightRules = acequire('./source_highlight_rules2').SourceHighlightRules
...
// @ts-ignore
ace.define(
  'ace/mode/source_highlight_rules2',
  [
    'require',
    'exports',
    'module',
