...
test('sym tree for fib function', () => {
    ...
    const symTree = symbolicExecute(program.body[0] as es.FunctionDeclaration, mockContext().runtime.environments[0])
 ...
 test('sym tree with conditional expr', () => {
  ...
  test('test variable declaration and global consts', () => {
    ...
    const symTree = symbolicExecute(program.body[0] as es.FunctionDeclaration, context.runtime.environments[0])
    expect(symTree).toMatchSnapshot()
  })
