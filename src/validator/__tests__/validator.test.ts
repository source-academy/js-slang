...
test('for loop variable cannot be reassigned', () => {
  ...
  return expectParsedError(code, { chapter: Chapter.SOURCE_4 }).toEqual(
    'Line 2: Assignment to a for loop variable within the body of the for loop is not allowed.'
  )
})
...
test('for loop variable cannot be reassigned in closure', () => {
  ...
  `
  return expectParsedError(code, { chapter: Chapter.SOURCE_4 }).toEqual(
    'Line 3: Assignment to a for loop variable within the body of the for loop is not allowed.'
  )
})
