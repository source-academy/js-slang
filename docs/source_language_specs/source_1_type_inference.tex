...
\begin{document}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\docheader{2021}{Source}{\S 1 Type Inference}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The letters $x$, $i$, $f$ and $s$ stand for names, integers, floats and strings, respectively.
...
We distinguish three kinds of type variables, $T_i$, $A_i$ and $N_i$, to be able to handle
...
&& \hspace{2mm} [ - \leftarrow \forall(N \rightarrow N)]\Gamma_{-2}
\end{eqnarray*}
...
& $[$ & \texttt{Infinity}      & $\leftarrow$  & $\forall(N)$ & & & $]$ \\
...
& $[$ & \texttt{math\_abs} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_acos} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_acosh} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_asin} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_asinh} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_atan} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_atan2} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_atanh} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_cbrt} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_ceil} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_clz32} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_cos} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_cosh} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_exp} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_expm1} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_floor} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_fround} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_hypot} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_imul} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_LN2} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_LN10} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_log} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_log1p} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_log2} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_LOG2E} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_log10} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_LOG10E} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_max} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_min} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_PI} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_pow} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_random} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_round} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_sign} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_sin} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_sinh} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_sqrt} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_SQRT1\_2} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_SQRT2} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_tan} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_tanh} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{math\_trunc} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{NaN} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{parse\_int} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{prompt} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{runtime} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{stringify} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ \\
& $[$ & \texttt{undefined} & $\leftarrow$  & $\Float$ & $\rightarrow$ & $\Float$ & $]$ & $\Gamma_0$ \\
& \end{tabular}
...
%% They assign a unique type (\texttt{number} for numbers, \texttt{bool} for
