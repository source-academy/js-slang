...
In this specification, we describe the behavior of compiling from Source to SVML, as well as running SVML, with natural deduction rules. Please refer to \hyperref[sec:org985890c]{Appendix A} for explanations about compilation rules and VM transition rules.
