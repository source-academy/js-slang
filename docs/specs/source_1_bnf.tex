\begin{alignat*}{9}
&& \textit{program}    &&\quad ::= &\quad && \textit{import-directives} \ \textit{statement} \ldots
                                                           && \textrm{\href{https://source-academy.github.io/sicp/chapters/3.1.1.html\#p6}{program}} \\[1mm]
&& \textit{import-directives}  && ::= &\quad && \epsilon\ | \ \textit{import-directive}\ (
                                                               \ \textbf{\texttt{,}} \
                                                                 \textit{import-directive} \ 
                                                                      ) \ldots \quad
                                                            && \textrm{import directives} \\[1mm]
