...
\markright{SICP, JavaScript Adaptation, JavaScript Style Guide, Version 2.0}
\begin{center}
  {\Large {\bf JavaScript Style Guide}---Version 2.1}\\[10mm]
...
\end{center}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent
This is the style guide for the JavaScript §1-4 sublanguages
used in the book \emph{Structure and Interpretation
...
\paragraph{Always use braces...} even if the block consists of only 
  one statement. This is required here, and recommended in JavaScript generally.
...
precedence than all other operators in JavaScript (except the assignment operator
...
by the first. This is illegal in JavaScript (strict mode).
\begin{lstlisting}
// illegal in JavaScript strict mode
function f(x, x) {
    ...
}
\end{lstlisting}
