...
&& \textit{rest-names}   && ::= &\quad &&  \epsilon\ | \  \textit{name} \ 
                                                   (\ \textbf{\texttt{,}} \ \textit{name}\ ) \ldots\ [\texttt{...}\textit{name}]
...
&& \textit{spread-expressions}  && ::= &\quad && \epsilon\ | \ \textit{expression}\ (
                                                               \ \textbf{\texttt{,}} \
                                                                 \textit{expression} \ 
                                                                 ) \ldots \\
&&                              &&     &      && \qquad [\texttt{...}\textit{expression}]
