...
of Computer Programs (SICP)\ book. The language also maintains compatibility with modules designed for \href{https://docs.sourceacademy.org/javascript/javascript_1/}{\color{DarkBlue}\emph{JavaScript \S 1-4}}, a family of JavaScript subsets intended for use with SICP on Source Academy.
