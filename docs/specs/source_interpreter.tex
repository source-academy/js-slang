...
&&                       && |   &\quad &&  \textit{expression}_1 \  \textit{bin-op} \ 
                                            \textit{expression}_2 \qquad
                                                           && \texttt{list("operator_combination",  } \langle \textit{bin-op}\rangle \textit{, } \langle \textit{expression}_1\rangle \textit{, } \langle \textit{expression}_2\rangle \textit{)} \\
&&                       && |   &\quad &&   \textit{un-op} \ 
                                            \textit{expression}
                                                           && \texttt{list("operator_combination",  } \langle \textit{un-op}\rangle \textit{, } \langle \textit{expression}\rangle \textit{)} \\
