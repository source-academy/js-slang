...
type ConstantDeclaration = Pair<"constant_declaration",
  Pair<Name, Pair<Expression, null>>>;
...
type ForLoop = Pair<"for_loop", Pair<Expression | VariableDeclaration,
  Pair<Expression, Pair<Expression, Pair<Block, null>>>>>;
...
// If-Statement
type ConditionalStatement = Pair<"conditional_statement", Pair<Expression,
  Pair<Block, Pair<Block | ConditionalStatement, null>>>>;
...
type ObjectAssignment = Pair<"object_assignment",
  Pair<ObjectAccess, Pair<Expression, null>>>;
...
type Name = Pair<"name", Pair<string, null>>;
  type LogicalComposition = Pair<"logical_composition", Pair<LogicalOperator,
Pair<Expression, Pair<Expression, null>>>>;
...
type Application = Pair<"application", Pair<Expression,
  Pair<List<Expression>, null>>>;
type LambdaExpression = Pair<"lambda_expression", Pair<Parameters,
  Pair<Statement, null>>>;
type ConditionalExpression = Pair<"conditional_expression", Pair<Expression,
  Pair<Expression, Pair<Expression, null>>>>;
