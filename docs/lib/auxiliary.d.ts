 ...
 */
declare function __access_export__(exports: typeof pair, lookup_name: string): value;
/**
 * Searches for the specified name in the data structure of exported names.
 ...
 * @returns {value} The value corresponding to the imported name
 */
declare function __access_named_export__(named_exports: typeof list, lookup_name: string): value;
